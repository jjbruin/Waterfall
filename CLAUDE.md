...
- **Display** — "PPI Ownership Waterfalls" dropdown between Annual Operating Forecast and Debt Service: PSC summary cards (fees/co-invest/distributions/IRR), participant table (net of fees), per-relationship breakdowns + collapsible quarterly fee schedules. Audit Excel gains a "PPI Ownership" tab.
